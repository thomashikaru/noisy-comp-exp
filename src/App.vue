...
<template>
  <Experiment title="Mouse tracking for Reading" translate="no" :imageAssets="imageArray">
    ...
    <Screen :title="'Welcome'" class="instructions" :validations="{
        ...
        <p>
          We would like to ask you if you are willing to participate in our research project. Your participation is voluntary. Please read the text below carefully.
        <br><br>
          <b>What is investigated and how?</b> You are being asked to take part in a research study being done by Thomas Clark, a researcher at the Massachusetts Institute of Technology. This study will help us learn about how people read. It will take you around 20 minutes to complete.
        <br><br>
        ...
        <br><br>
          <b>Who funds this study?</b> This study is funded by ...
        <br><br>
          <b> Who reviewed this study?  </b> This study is approved by MIT's COUHES.
        <br><br>
        ...
        <br>
          ...
          <tr>
          <td>Please enter your Prolific ID to continue:&nbsp;</td><td><input name="TurkID" type="text" class="obligatory" v-model="$magpie.measurements.SubjectID"/></td>
          </tr>
          <tr>
